/*
 * Domain Decomposition across columns
 */
...
#define CHUNK_SIZE 1 // This is 1 because BlOCK_SIZE controls how many columns each thread grabs.
#define BLOCK_SIZE 32 // This will control how many columns each thread grabs.
